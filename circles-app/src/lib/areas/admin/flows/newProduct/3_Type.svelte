<script lang="ts">
  ...
  let selectedType = $state<
    Exclude<import('$lib/areas/admin/types').AdminProductType, 'route'>
  ...
  <div class="space-y-3">
    <label class="flex items-start gap-2">
      ...
      <span>
        ...
        <div class="text-xs opacity-70">
          Serve a finite pool of codes and optionally a download URL per
          purchase.
        </div>
      </span>
    </label>
    <label class="flex items-start gap-2">
      ...
      <span>
        ...
        <div class="text-xs opacity-70">
          Sync fulfillment with your Odoo inventory and dispatch workflows.
        </div>
      </span>
    </label>
    <label class="flex items-start gap-2">
      ...
      <span>
        ...
        <div class="text-xs opacity-70">
          Mint one ticket NFT key per successful fulfillment run.
        </div>
      </span>
    </label>
