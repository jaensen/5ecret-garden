...
<style>
  .gui-row {
    ...
    --gui-row-pad-y: .75rem;
    --gui-row-gap: .75rem;
    --gui-row-radius: .875rem;
    --gui-row-bg: #fff;
    --gui-row-bg-hover: #f8fafc;
    --gui-row-bg-selected: #eff6ff;
    --gui-row-border: #d4d4d8;
    --gui-row-border-hover: #a1a1aa;
    --gui-row-border-selected: #93c5fd;
    --gui-row-focus: #2563eb;
    --gui-row-fg: #18181b;
    --gui-row-muted: #52525b;
    --gui-row-muted-2: #71717a;
  ...
  .gui-row[data-ui-row-selected='true'] { background: var(--gui-row-bg-selected); border-color: var(--gui-row-border-selected); box-shadow: inset 0 0 0 2px var(--gui-row-border-selected); }
